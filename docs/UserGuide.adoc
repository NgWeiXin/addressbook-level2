...
== Undo-ing previous delete: `undoDelete`

Undo the latest delete command.
Format: `undoDelete`

***
Adds back the person that was being recently deleted.
Person will have a different index number.
***
